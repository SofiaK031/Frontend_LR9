document.addEventListener("DOMContentLoaded", () => {
    ...
    let suit = ['js/./images/6.png', 'js/./images/7.png', 'js/./images/8.png', 'js/./images/9.png', 'js/./images/10.png', 'js/./images/jack.png', 'js/./images/queen.png', 'js/./images/king.png', 'js/./images/ace.png'];
